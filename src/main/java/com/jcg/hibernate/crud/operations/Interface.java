...
public class Interface extends JFrame implements ActionListener {
    ...
    public Interface() {
        ...
        JPanel painel = new JPanel(new GridLayout(6, 4));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == botaoLer) {
            ...
            DefaultListModel<Contato> modeloLista = new DefaultListModel<Contato>();
            ...
            JList<Contato> listaContatos = new JList<Contato>(modeloLista);
            ...
            DbOperations.updateRecord(Integer.parseInt(ExcluirID), endereco, nome, telefone);
        }
